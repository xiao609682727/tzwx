      ...
      <template slot-scope="scope" slot="menu">
        <el-dropdown size="small">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item @click.native="showPwd(scope.row)" >重置密码</el-dropdown-item>
...
<script>
  import {getList, getDetail, add, update, remove, setPassword} from "@/api/user/student";
  ...
  import userloginlog from "../user/userloginlog";
          ...
          column: [
            {
              ...
              action: "/api/user/student/import-user-agent"
            },
            {
              label: '模板下载',
              prop: 'excelTemplate',
