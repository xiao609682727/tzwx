  ...
  <basic-container>
    <avue-crud :option="option"
      ...
      <template slot-scope="scope" slot="menu">
        ...
        <el-button type="text" @click="openCourseOrderRecordbtn(scope.row)" >查看订单</el-button>
      </template>
    </avue-crud>
    ...
    <el-dialog title="班级学习详情" width="80%"  :visible.sync="coursePackageStudyhistory" append-to-body>
