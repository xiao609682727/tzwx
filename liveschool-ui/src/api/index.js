...
//获取课程
export const course = (current,size,sellType,level,subjectId,courseName,orderBy) => {
  return request({
...
//查询用户最新考试记录
export const examPaperByUserId = (userId,subjectId) => {
  return request({
    url: baseUrl + '/front/exam/examHistoy/'+userId,
    method: 'get',
    params:{
      subjectId:subjectId
    }
...
export const checkComment = (params) => {
  return request({
    url: baseUrl + '/front/comment/checkComment',
    method: 'get',
    params: params
  })
}
...
export const exampaperRecordById = (id) => {
  return request({
    url: baseUrl + '/api/front/exam/exampaperRecord/'+id,
    method: 'get',
  })
}