...
<script>
  import {getDetail, add, update, remove, getEndTimeType,geClassPage,subjectTree} from "@/api/edu/course";
  ...
  export default {
    ...
    methods: {
      ...
      onLoad(page, params = {}) {
        this.loading = true;
        geClassPage(page.currentPage, page.pageSize, Object.assign(params, this.query)).then(res => {
