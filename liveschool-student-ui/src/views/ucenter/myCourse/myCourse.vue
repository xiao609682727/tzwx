<template>
  <div class="u-container">
    <div class="c-tab clearfix">
      ...
      <div class="fr">
        <a @click="showCourseCardJihuo()" href="javascrpt:void(0)" class="course_card_btn ">学习卡激活</a>
      </div>
    </div>
        ...
        <div class="courseitem tl-item"  v-for="detail in detailList" :key="detail.id">
          ...
          <div class="info-box course-list">
            ...
            <div class="catog-points" v-if="detail.trxorderType != 'LINECLASS'">
              ...
              <a @click="gotoPlay(detail.courseId,detail.trxorderType)" href="javascrpt:void(0)" class="btn-red continute-btn">继续学习</a>
            </div>
            <div class="catog-points" v-if="detail.trxorderType == 'LINECLASS'&&detail.lineTeacherIs==1">
