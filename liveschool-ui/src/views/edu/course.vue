  ...
  <basic-container>
    <avue-crud :search.sync="search" :option="option"
      ...
      <template slot-scope="scope" slot="menu">
        ...
        <el-button type="text" icon="el-icon-notebook-2" size="small" @click="openStudent(scope.row)">赠送课程</el-button>
    ...
    <el-dialog title="赠送课程" width="80%"  :visible.sync="dialogStudentVisible">
    ...
    <el-dialog title="学习记录" width="80%"  :visible.sync="dialogStudyHistory" append-to-body>
      <studyhistory v-if="dialogStudyHistory" :courseId="courseId" :courseType="courseType" :kpointCouserId="kpointCouserId"></studyhistory>
    </el-dialog>
...
<script>
  import {getList, getDetail, add, update, remove, getEndTimeType,give,getTeacherDetail,subjectTree,selectCourseKpoint} from "@/api/edu/course";

  import {mapGetters} from "vuex";
  import coursekpoint from "./coursekpoint";
  import student from "./student";
  import teacher from "./teacher";
  import comment from "./comment";
  import studyhistory from "./coursestudyKpointhistory";
  import courseStudyStudenthistory from "./courseStudyStudenthistory";
