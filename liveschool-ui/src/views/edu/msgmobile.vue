    ...
    <avue-crud :option="option"
      ...
      <template slot="menuLeft">
        ...
        <el-button type="danger"
                   ...
                   icon="el-icon-delete"
                   plain
                   v-if="permission.msgmobile_delete"
      ...
      <template slot-scope="scope" slot="menu">
        <el-button type="text" @click="resendMobile(scope.row)"  size="small" >重新发送</el-button>
      </template>
    </avue-crud>
...
<script>
  import {getList, getDetail, add, update, remove, sendMobile} from "@/api/edu/msgmobile";
  ...
  export default {
        ...
        option: {
          ...
          column: [
            ...
            },
            {
              ...
              prop: "content",
              type:"textarea",
              placeholder:"例：{'code':1234,'title':'通知标题'}",
              tip:"需要根据选择的短信模板配置参数",
              span:24,
            },
            {
    ...
    computed: {
      ...
      permissionList() {
        return {
          addBtn: this.vaildData(this.permission.msgmobile_add, false),
          viewBtn: this.vaildData(this.permission.msgmobile_view, false),
          delBtn: this.vaildData(this.permission.msgmobile_delete, false),
          editBtn: this.vaildData(this.permission.msgmobile_edit, false)
        };
      },
      ids() {
        let ids = [];
