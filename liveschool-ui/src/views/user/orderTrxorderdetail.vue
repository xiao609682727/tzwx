...
<script>
  import {getList,getListForUser, getDetail, add, update, remove} from "@/api/edu/trxorderdetail";
  ...
  export default {
    data() {
      return {
        form: {},
        srarch:{},
        query: {trxorderId:this.orderId,orderNo:this.orderNo},
        loading: true,
        page: {
          pageSize: 10,
          currentPage: 1,
    ...
    methods: {
      ...
      onLoad(page, params = {trxorderId:this.orderId}) {
        this.loading = true;
          getListForUser(page.currentPage, page.pageSize, Object.assign(params, this.query)).then(res => {
